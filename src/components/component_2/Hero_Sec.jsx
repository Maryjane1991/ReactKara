...
const Hero_Sec = () => {
  return (
    <section className="bg-#68D5851A min-h-screen px-5 lg:px-[113px] grid grid-cols-1 lg:grid-cols-2 items-center gap-[100px] mt-20 text-brainyWaveBlack bg-brainyGreen/10">
      <div className="">
        <div>
